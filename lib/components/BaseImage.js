...
var BaseImageComponent = module.exports = React.createClass({
    ...
    getInitialState: function () {
        ...
        // Build out candidates and store in context
        this._candidates = BaseImageComponent._buildCandidates(this.props.srcSet);

        return {
            w: Utils.getWidth(),
            x: Utils.getDensity(),
            src: this._candidates[0].url
        };
    },
    ...
    componentDidMount: function () {
        ...
        if (this.props.nativeSupport !== 'full') {
            ...
            this.setState({
                src: BaseImageComponent._matchImage(this._candidates,
                                                    Utils.getWidth(),
                                                    Utils.getDensity())
            });
        }
